...
> **Note:** the package is not yet on pub.dev. The first publish requires a one-time manual upload to bootstrap the package and attach automated publishing — see [PUBLISHING.md](PUBLISHING.md). Until that lands, install via the git URL below.
